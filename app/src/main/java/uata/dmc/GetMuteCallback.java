...
public class GetMuteCallback extends GetMute {
  ...
  /**
   *@see org.fourthline.cling.support.renderingcontrol.callback.GetMute#received(org.fourthline.cling.model.action.ActionInvocation, boolean)
   *@Title: received
