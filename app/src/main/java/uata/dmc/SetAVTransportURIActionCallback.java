...
public class SetAVTransportURIActionCallback extends SetAVTransportURI {
  ...
  /**
   *@see org.fourthline.cling.support.avtransport.callback.SetAVTransportURI#success(org.fourthline.cling.model.action.ActionInvocation)
   *@Title: success
